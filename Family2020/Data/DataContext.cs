        ...
        public class DataContext
        {
            ...
            public DataContext()
            {
                ...
                var family4 = new Family()
                {
                    ...
                    Father = new Adult() { Name = "Oax", DateOfBirth = DateTime.Now.AddYears(-28), Job = "Architect ", LicenseNumber = "2344454", PersonId = 45 },
                    ...
                    Children = new List<Person>()
                 {
                   ...
                   new Person() {Name = "Olla",DateOfBirth = new DateTime(2004,8,16),PersonId =42},
